<template>
	<view class="express-details-page">
		<image class="service-image" src="/static/images/daina.jpg" mode="aspectFill"></image>
		...
		<view class="form-card">
			...
			<view class="form-item">
				...
				<view class="segmented-control">
					<text v-for="(item, index) in packageSizes" :key="index" :class="['option', { active: packageSize === item }]" @click="packageSize = item">{{ item }}</text>
				</view>
			</view>
			...
			<view class="form-item">
				...
				<view class="segmented-control">
					<text v-for="(item, index) in weights" :key="index" :class="['option', { active: weight === item }]" @click="weight = item">{{ item }}</text>
				</view>
			</view>
		</view>
