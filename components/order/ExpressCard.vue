  ...
  <div class="order-card express-card">
    <div class="card-header">
      <div class="order-type">
        <uni-icons type="paperplane-filled" size="20" color="#2979ff"></uni-icons>
        <span class="type-text">快递代拿</span>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="info-row">
        <span class="label">快递大小:</span>
        <span class="value">{{ packageSizeText }}</span>
      </div>
      <div class="info-row">
        <span class="label">预估重量:</span>
        <span class="value">{{ order.data.estimatedWeight }} kg</span>
      </div>
      <div class="info-row">
